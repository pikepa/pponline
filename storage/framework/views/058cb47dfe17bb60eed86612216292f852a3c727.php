...
<head>
    ...
    <!-- Style sheets-->
    <?php if(@auth('wink')->user()->meta['theme'] == 'dark'): ?>
        <link href='<?php echo e(mix('dark.css', 'vendor/wink')); ?>' rel='stylesheet' type='text/css'>
...
<!-- Global Wink Object -->
<script>
    window.Wink = <?php echo json_encode($winkScriptVariables, 15, 512) ?>;
</script>

<script src="<?php echo e(mix('app.js', 'vendor/wink')); ?>"></script>
</body>
</html>
<?php /**PATH /Users/peterpike/Sites/Development/peterpike/vendor/writingink/wink/src/../resources/views/layout.blade.php ENDPATH**/ ?>